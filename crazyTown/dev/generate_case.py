...
def crazyTown():
    ...
    Vehicle1 = Vehicle(ID="V1",source_strength=0.8,imag_source_strength=0.85)
    Vehicle1.Set_Goal([0.5, 0.3, 0.4], 5, 0)    
    Vehicle1.Set_Position([-0.1, 0 , 0.4])
    # Vehicle1.Go_to_Goal(0.5,0,0,0)

    Vehicle2 = Vehicle(ID="V2",source_strength=0.8,imag_source_strength=0.85)
    Vehicle2.Set_Goal([1, 0.0, 0.5], 5, 0)    
    Vehicle2.Set_Position([-0.1, 0 , 0.4])
    # Vehicle2.Go_to_Goal(0.5,0,0,0)

    Vehicle3 = Vehicle(ID="V2",source_strength=0.8,imag_source_strength=0.85)
    Vehicle3.Set_Goal([-1, 0.0, 0.5], 5, 0)    
    Vehicle3.Set_Position([-0.1, 0 , 0.4])
    # Vehicle2.Go_to_Goal(0.5,0,0,0)
    ...
    case.add_case(ID="CT_demo_3v",building_list=buildings,vehicle_list=vehicles)
    print(f'CrazyTown three vehicle demo added into {case.filename}')
