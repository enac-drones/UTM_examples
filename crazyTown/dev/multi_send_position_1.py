...
def start_position_printing(scf):
    ...
    log_conf.data_received_cb.add_callback(position_callback(logconf=log_conf, scf=scf))
    log_conf.start()
...
if __name__ == '__main__':
    ...
    position_printing(scf1)
    position_printing(scf2)
    ...
    #     time.sleep(0.1)
    for i in range(30):
        scf1.cf.commander.send_velocity_world_setpoint(0.3, 0., 0.,  yawrate=55.0)
        scf2.cf.commander.send_velocity_world_setpoint(0.3, 0., 0.,  yawrate=55.0)
        position_printing(scf1)
        position_printing(scf2)
        time.sleep(0.1)
    for i in range(30):
